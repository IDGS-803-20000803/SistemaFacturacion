        ...
        public int Insertar(BE.IncidenciasBE objDatosBE)
        {
            try
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    cmd.CommandText = "SP_INCIDENCIAS_INSERTAR";
                    cmd.Parameters.Add("pIncidencia", MySqlDbType.VarChar, 255).Value = objDatosBE.incidencia;
                    cmd.Parameters.Add("pDescripcion", MySqlDbType.VarChar, 100).Value = objDatosBE.descripcion;
                    cmd.Parameters.Add("pIdTipo", MySqlDbType.Int32).Value = objDatosBE.id_tipo_incidencia;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pIdSolucion", MySqlDbType.VarChar, 5000).Value = objDatosBE.soluciones;
                    cmd.Parameters.Add("pTotal", MySqlDbType.Int32).Value = objDatosBE.total;
                    ...
                    if (intResultado > 0)
                        ...
                        throw new Exception("La incidencia ya se encuentra registrada");
                    else
        ...
        public int Modificar(BE.IncidenciasBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_INCIDENCIAS_MODIFICAR";
                    cmd.Parameters.Add("pIncidencia", MySqlDbType.VarChar, 255).Value = objDatosBE.incidencia;
                    cmd.Parameters.Add("pDescripcion", MySqlDbType.VarChar, 100).Value = objDatosBE.descripcion;
                    cmd.Parameters.Add("pIdTipo", MySqlDbType.Int32).Value = objDatosBE.id_tipo_incidencia;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
        ...
        public int Eliminar(BE.IncidenciasBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_INCIDENCIAS_ELIMINAR";
                    cmd.Parameters.Add("pId", MySqlDbType.Int32).Value = objDatosBE.id;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pFecha", MySqlDbType.Datetime).Value = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                    cmd.Parameters["pId"].Direction = System.Data.ParameterDirection.InputOutput;
