        ...
        public int Insertar(BE.ColoresBE objDatosBE)
        {
            try
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    cmd.CommandText = "SP_COLORES_INSERTAR";
                    ...
                    cmd.Parameters.Add("pIdEstatus", MySqlDbType.Int32).Value = objDatosBE.id_estatus;
                    cmd.Parameters.Add("pR", MySqlDbType.Int32).Value = objDatosBE.r;
                    cmd.Parameters.Add("pG", MySqlDbType.Int32).Value = objDatosBE.g;
                    cmd.Parameters.Add("pB", MySqlDbType.Int32).Value = objDatosBE.b;
                    ...
                    if (intResultado > 0)
                        ...
                        throw new Exception("El color ya fue registrado previamente");
                    else
        ...
        public int Modificar(BE.ColoresBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_COLORES_MODIFICAR";
                    cmd.Parameters.Add("pDescripcion", MySqlDbType.VarChar, 100).Value = objDatosBE.descripcion;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pIdEstatus", MySqlDbType.Int32).Value = objDatosBE.id_estatus;
                    cmd.Parameters.Add("pR", MySqlDbType.Int32).Value = objDatosBE.r;
        ...
        public int Eliminar(BE.ColoresBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_COLORES_ELIMINAR";
                    cmd.Parameters.Add("pId", MySqlDbType.Int32).Value = objDatosBE.id;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pFecha", MySqlDbType.Datetime).Value = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                    cmd.Parameters["pId"].Direction = System.Data.ParameterDirection.InputOutput;
