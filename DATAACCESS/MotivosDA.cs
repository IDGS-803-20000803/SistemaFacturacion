        ...
        public int Insertar(BE.MotivosBE objDatosBE)
        {
            try
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    cmd.CommandText = "SP_MOTIVOS_INSERTAR";
                    cmd.Parameters.Add("pMotivo", MySqlDbType.VarChar, 50).Value = objDatosBE.motivo;
                    cmd.Parameters.Add("pDescripcion", MySqlDbType.VarChar, 2000).Value = objDatosBE.descripcion;
                    ...
                    if (intResultado > 0)
                        ...
                        throw new Exception("El motivo ya se encuentra registrado");
                    else
        ...
        public int Modificar(BE.MotivosBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_MOTIVOS_MODIFICAR";
                    cmd.Parameters.Add("pMotivo", MySqlDbType.VarChar, 50).Value = objDatosBE.motivo;
                    cmd.Parameters.Add("pDescripcion", MySqlDbType.VarChar, 2000).Value = objDatosBE.descripcion;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pIdTipo", MySqlDbType.Int32).Value = objDatosBE.id_tipo;
        ...
        public int Eliminar(BE.MotivosBE objDatosBE)
        {
            try
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    int intResultado;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "SP_MOTIVOS_ELIMINAR";
                    cmd.Parameters.Add("pId", MySqlDbType.Int32).Value = objDatosBE.id;
                    cmd.Parameters.Add("pIdUsuario", MySqlDbType.Int32).Value = objDatosBE.id_usuario;
                    cmd.Parameters.Add("pFecha", MySqlDbType.Datetime).Value = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                    cmd.Parameters["pId"].Direction = System.Data.ParameterDirection.InputOutput;
